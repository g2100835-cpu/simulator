content = open('data/events.yaml','r',encoding='utf-8').read()
  ...
  panopticism:
    ...
    events:
      ...
      - id: pan_shame_education
        ...
        age_range: [4, 10]
        weight: 0.6
        description: 「犯错时不是被告知这是错的，而是别人看到会怎样——羞耻感替代体罚」
        outcomes:
      ...
      - id: pan_algorithmic_employment
        ...
        age_range: [20, 30]
        weight: 0.55
        description: 「简历被AI筛选——年龄、学历、社交媒体——算法裁决代替人的判断」
        outcomes:
...
"""
open('data/events.yaml','w',encoding='utf-8').write(content + append)
print('Done')
